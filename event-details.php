						...
						<div class="row justify-content-center">
							<div class="col-lg-6 col-md-12 col-sm-12">
								...
								<div class="breadcrumb-title text-center mb-50">
									...
									<h2 class="big-title">ShaShiSha  <strong>event details</strong></h2>
								</div>
									...
									<li class="rt-body">
										<div class="rt-body-item">
											<div class="leftside-content">
												<h3 class="ticket-title">ShaShiSha  Package 1</h3>
										...
										<div class="rt-body-item">
											<div class="leftside-content">
												<h3 class="ticket-title">ShaShiSha  Package 2</h3>
												<span class="ticket-price">$120.00 + FEE $5.00</span>
											</div>
											<div class="rightside-content">
												<div class="ticket-select">
										...
										<div class="rt-body-item">
											<div class="leftside-content">
												<h3 class="ticket-title">ShaShiSha  Package 3</h3>
												<span class="ticket-price">$120.00 + FEE $5.00</span>
											</div>
											<div class="rightside-content">
												<div class="ticket-select">
